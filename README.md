...
This is a severless Image CICD application created from AWS SAM template (AWS Cloud Formation), this project consists of AWS serverless services and development codes that are used in the Image CICD pipeline, for instances: CodePipeline, CodeBuild project, Lambda Functions, etc.
